 ...
 * @brief 此文件用于迭代器设计，包含一些模板结构体与全局函数
 * @version 0.1
 * @date 2022-02-25
 * 
...
namespace mystl {
    ...
    // distance 的random_access_iterator_tag的版本
    ...
    // advance 的 input_iterator_tag的版本
    ...
    // advance 的 bidirectional_iterator_tag的 的版本
