...
| 题目                                                         | 难度 | 题解文件                                                     | 方法   |
| ------------------------------------------------------------ | ---- | ------------------------------------------------------------ | ------ |
| [1046. 最后一块石头的重量](https://leetcode.cn/problems/last-stone-weight/) | 简单 | [1046. 最后一块石头的重量.md](堆\1046. 最后一块石头的重量.md) | 最大堆 |
...
| 题目                                                         | 难度 | 题解文件                                            | 方法 |
| ------------------------------------------------------------ | ---- | --------------------------------------------------- | ---- |
| [690. 员工的重要性](https://leetcode.cn/problems/employee-importance/) | 中等 | [690. 员工的重要性.md](图\BFS\690. 员工的重要性.md) | BFS  |
|                                                              |      |                                                     |      |
|                                                              |      |                                                     |      |
